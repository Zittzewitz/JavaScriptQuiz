...
function renderQuiz() {
  ...
  document.writeln('<p><input type="submit" value="Zeige Ergebniss" onclick="showScore()" /> <input type="submit" value="Lösche Quiz" onclick="quizNeustarten(true)" /></p><p style="display:none"><img src="richtig.gif" style="border:0" alt="richtig!" /><img src="falsch.gif" style="border:0" alt="falsch!" /></p>');
}
